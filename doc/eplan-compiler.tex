...
% \setmonofont[Scale=MatchLowercase]{Anonymous Pro}	% does not work
% \setmonofont[Scale=MatchLowercase]{Consolas}	% does not work
% \setmonofont[Scale=MatchLowercase]{Courier New}
% \setmonofont[Scale=MatchLowercase]{Cousine}
\setmonofont[Scale=MatchLowercase]{DejaVu Sans Mono}
% \setmonofont[Scale=MatchLowercase]{Fantasque Sans Mono}	% does not work
...
% \setmonofont[Scale=MatchLowercase]{Ubuntu Mono}	% does not work
% % 
...
\begin{frame}[fragile,allowframebreaks]{Algumas operações com tipos}
  \begin{description}
    ...
    \item[\pyginline|boolean canBe(Type type)|]\mbox{}\newline
    \begin{itemize}
    ...
    \item[\pyginline|boolean canBe(Type... types)|]\mbox{}\newline
    \begin{itemize}
...
\begin{frame}[fragile,allowframebreaks]{Reportando erros comuns}
  \begin{itemize}
    \item A interface \pyginline|error.CommonErrors| define alguns
    métodos para reportar erros comumente encontrados pelo compilador.
...
\begin{frame}[fragile,allowframebreaks]{Atividade 2: literal inteiro}
  ...
  \begin{enumerate}
    ...
    biblioteca padrão de \lang{} para exibir um valor inteiro.
